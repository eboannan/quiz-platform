        ...
        <section className="container grid-cols-2" style={{
            ...
            <div className="animate-fade-in" style={{ position: 'relative', animationDelay: '0.2s' }}>
                ...
                <div style={{
                    ...
                    <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem' }}>Question 4/10</h3>
                    <p style={{ fontSize: '1.2rem', marginBottom: '2rem', fontWeight: '500' }}>What is the formula for Force?</p>
